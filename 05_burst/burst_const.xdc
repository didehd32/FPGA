...
set_property PACKAGE_PIN P15 [get_ports {buz_o[1]}]
set_property PACKAGE_PIN R17 [get_ports {buz_o[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {buz_o[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {buz_o[0]}]
